...
import Image100 from '../asset/Our gallery/HindiDiwas_25/img1.webp';
import Image101 from '../asset/Our gallery/HindiDiwas_25/img2.webp';
import Image102 from '../asset/Our gallery/HindiDiwas_25/img3.webp';
import Image103 from '../asset/Our gallery/HindiDiwas_25/img4.webp';
import Image104 from '../asset/Our gallery/HindiDiwas_25/img5.webp';

function HindiDiwas_25() {
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const images = [
    { src: Image100, date: '30 May 2025' },
    { src: Image101, date: '30 May 2025' },
    { src: Image102, date: '30 May 2025' },
    { src: Image103, date: '30 May 2025' },
    { src: Image104, date: '30 May 2025' }
  ];
      ...
      <div className="container">
        <div className="p-4 mx-auto text-center" style={styles.card}>
          <h2 className="mb-4 fw-bold text-primary">
              Hindi Patrakarita Udbhav Diwas
            <br /><small>30 May 2025</small>
          </h2>
            ...
            {images.map((img, i) => (
              <div key={i} className="col-6 col-md-4 mb-3">
                ...
                >
                  ...
                  <div className="overlay" style={styles.overlay}> Hindi Patrakarita Udbhav Diwas | 30 May 2025 </div>
                </div>
              </div>
            ))}
          </div>
      ...
      {zoomIndex !== null && (
        <div style={styles.zoom} onMouseMove={handleMouseMove}>
          ...
          <div style={{ ...styles.tooltip, top: hoverPos.y, left: hoverPos.x }}>
            Hindi Patrakarita Udbhav Diwas | 30 May 2025
          </div>
        </div>
      )}
    </div>
