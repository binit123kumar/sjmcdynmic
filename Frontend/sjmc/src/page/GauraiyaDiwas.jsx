...
import Image100 from '../asset/Our gallery/GauraiyaDiwas/img1.webp';
import Image101 from '../asset/Our gallery/GauraiyaDiwas/img2.webp';
import Image102 from '../asset/Our gallery/GauraiyaDiwas/img3.webp';
import Image103 from '../asset/Our gallery/GauraiyaDiwas/img4.webp';
import Image104 from '../asset/Our gallery/GauraiyaDiwas/img5.webp';
import Image105 from '../asset/Our gallery/GauraiyaDiwas/img6.webp';
import Image106 from '../asset/Our gallery/GauraiyaDiwas/img7.webp';
import Image107 from '../asset/Our gallery/GauraiyaDiwas/img8.webp';

function GauraiyaDiwas() {
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const images = [
    { src: Image100, date: '30 April 2025' },
    { src: Image101, date: '30 April 2025' },
    { src: Image102, date: '30 April 2025' },
    { src: Image103, date: '30 April 2025' },
    { src: Image104, date: '30 April 2025' },
    { src: Image105, date: '30 April 2025' },
    { src: Image106, date: '30 April 2025' },
    { src: Image107, date: '30 April 2025' },
            ...
            {images.map((img, i) => (
              <div key={i} className="col-6 col-md-4 mb-3">
                ...
                >
                  ...
                  <div className="overlay" style={styles.overlay}>Gauraiya Diwas | 30 April 2025</div>
                </div>
              </div>
            ))}
          </div>
