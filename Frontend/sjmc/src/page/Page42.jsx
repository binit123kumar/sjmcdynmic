...
import Image1 from '../asset/Our gallery/screen writing/image (1).webp';
import Image2 from '../asset/Our gallery/screen writing/image (2).webp';
import Image3 from '../asset/Our gallery/screen writing/image (3).webp';
import Image4 from '../asset/Our gallery/screen writing/image (4).webp';
import Image5 from '../asset/Our gallery/screen writing/image (5).webp';
import Image6 from '../asset/Our gallery/screen writing/image (6).webp';
function Page42() {
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const images = [
    { src: Image1, date: '25 October 2024' },
    { src: Image2, date: '24 July 2024' },
    { src: Image6, date: '24 July 2024' },
    { src: Image3, date: '24 July 2024' },
    { src: Image4, date: '24 July 2024' },
    { src: Image5, date: '24 July 2024' },
  ];
      ...
      <div className="container">
        <div className="p-4 mx-auto text-center" style={styles.card}>
          <h2 className="mb-4 fw-bold text-primary">
           Screen Writing and Its Technical Aspects
            <br /><small>25 October 2024</small>
          </h2>
            ...
            {images.map((img, i) => (
              <div key={i} className="col-6 col-md-4 mb-3">
                ...
                >
                  ...
                  <div className="overlay" style={styles.overlay}>Screen Writing and Its Technical Aspects | 25 October 2024</div>
                </div>
              </div>
            ))}
          </div>
      ...
      {zoomIndex !== null && (
        <div style={styles.zoom} onMouseMove={handleMouseMove}>
          ...
          <div style={{ ...styles.tooltip, top: hoverPos.y, left: hoverPos.x }}>
            Screen Writing and Its Technical Aspects | 25 October 2024
          </div>
        </div>
      )}
    </div>
