...
import Image100 from '../asset/Our gallery/VJDivas/img1.webp';
import Image101 from '../asset/Our gallery/VJDivas/img2.webp';
import Image102 from '../asset/Our gallery/VJDivas/img3.webp';
import Image103 from '../asset/Our gallery/VJDivas/img4.webp';
import Image104 from '../asset/Our gallery/VJDivas/img5.webp';
import Image105 from '../asset/Our gallery/VJDivas/img6.webp';
import Image106 from '../asset/Our gallery/VJDivas/img7.webp';
import Image107 from '../asset/Our gallery/VJDivas/img8.webp';

function VJDivas () {
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const images = [
    { src: Image100, date: '12 July 2025' },
    { src: Image101, date: '12 July 2025' },
    { src: Image102, date: '12 July 2025' },
    { src: Image103, date: '12 July 2025' },
    { src: Image104, date: '12 July 2025' },
    { src: Image105, date: '12 July 2025' },
    { src: Image106, date: '12 July 2025' },
    { src: Image107, date: '12 July 2025' },
  ];
      ...
      <div className="container">
        <div className="p-4 mx-auto text-center" style={styles.card}>
          <h2 className="mb-4 fw-bold text-primary">
            Vishwa Jansankhya Diwas (nukkar natak)
            <br /><small>12 July 2025</small>
          </h2>
            ...
            {images.map((img, i) => (
              <div key={i} className="col-6 col-md-4 mb-3">
                ...
                >
                  ...
                  <div className="overlay" style={styles.overlay}>Vishwa Jansankhya Diwas (nukkar natak) | 12 July 2025</div>
                </div>
              </div>
            ))}
          </div>
      ...
      {zoomIndex !== null && (
        <div style={styles.zoom} onMouseMove={handleMouseMove}>
          ...
          <div style={{ ...styles.tooltip, top: hoverPos.y, left: hoverPos.x }}>
            Vishwa Jansankhya Diwas (nukkar natak) | 12 July 2025
          </div>
        </div>
      )}
    </div>
