...
import Image108 from '../asset/Our gallery/Student_Interaction_2026/img1.webp'
import Image109 from '../asset/Our gallery/Student_Interaction_2026/img2.webp'
import Image110 from '../asset/Our gallery/Student_Interaction_2026/img3.webp'
import Image111 from '../asset/Our gallery/Student_Interaction_2026/img4.webp'
import Image113 from '../asset/Our gallery/Student_Interaction_2026/img5.webp'
import Image114 from '../asset/Our gallery/Student_Interaction_2026/img6.webp'
import Image115 from '../asset/Our gallery/Student_Interaction_2026/img7.webp'
import Image116 from '../asset/Our gallery/Student_Interaction_2026/img8.webp'


function Student_Interaction() {
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const images = [
    { src: Image108, date: '7 Jan 2026' },
    { src: Image109, date: '7 Jan 2026' },
    { src: Image110, date: '7 Jan 2026' },
    { src: Image111, date: '7 Jan 2026' },
    { src: Image113, date: '7 Jan 2026' },
    { src: Image114, date: '7 Jan 2026' },
    { src: Image115, date: '7 Jan 2026' },
    { src: Image116, date: '7 Jan 2026' },
  ];
      ...
      <div className="container">
        <div className="p-4 mx-auto text-center" style={styles.card}>
          <h2 className="mb-4 fw-bold text-primary">
               Student Interaction 2026 | 
            <br /><small>07 Jan 2026</small>
          </h2>
            ...
            {images.map((img, i) => (
              <div key={i} className="col-6 col-md-4 mb-3">
                ...
                >
                  ...
                  <div className="overlay" style={styles.overlay}> Student Interaction 2026 | 07 Jan 2026</div>
                </div>
              </div>
            ))}
          </div>
      ...
      {zoomIndex !== null && (
        <div style={styles.zoom} onMouseMove={handleMouseMove}>
          ...
          <div style={{ ...styles.tooltip, top: hoverPos.y, left: hoverPos.x }}>
             Student Interaction 2026 | 07 Jan 2026
          </div>
        </div>
      )}
    </div>
...
export default Student_Interaction;