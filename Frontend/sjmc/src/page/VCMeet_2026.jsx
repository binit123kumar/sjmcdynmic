...
import Image100 from '../asset/Our gallery/VC Meet_2026/img1.webp';
import Image101 from '../asset/Our gallery/VC Meet_2026/img2.webp';
import Image102 from '../asset/Our gallery/VC Meet_2026/img3.webp';
import Image103 from '../asset/Our gallery/VC Meet_2026/img4.webp';
import Image104 from '../asset/Our gallery/VC Meet_2026/img5.webp';


function VCMeet_2026() {
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const images = [
    { src: Image100, date: '22 Dec 2025' },
    { src: Image101, date: '22 Dec 2025' },
    { src: Image102, date: '22 Dec 2025' },
    { src: Image103, date: '22 Dec 2025' },
    { src: Image104, date: '22 Dec 2025' },
      ...
      <div className="container">
        <div className="p-4 mx-auto text-center" style={styles.card}>
          <h2 className="mb-4 fw-bold text-primary">
            Vice Chancellor Meet 2026 
            <br /><small>22-23 Dec 2025</small>
          </h2>
            ...
            {images.map((img, i) => (
              <div key={i} className="col-6 col-md-4 mb-3">
                ...
                >
                  ...
                  <div className="overlay" style={styles.overlay}> Vice Chancellor Meet 2026 | 22-23 Dec 2025</div>
                </div>
              </div>
            ))}
          </div>
      ...
      {zoomIndex !== null && (
        <div style={styles.zoom} onMouseMove={handleMouseMove}>
          ...
          <div style={{ ...styles.tooltip, top: hoverPos.y, left: hoverPos.x }}>
            Vice Chancellor Meet 2026 | 22-23 Dec 2025
          </div>
        </div>
      )}
    </div>
