...
//import Image100 from '../asset/Our gallery/CampusConnection/img1.webp';
import Image101 from '../asset/Our gallery/CampusConnection/img2.webp';
import Image102 from '../asset/Our gallery/CampusConnection/img3.webp';
import Image103 from '../asset/Our gallery/CampusConnection/img4.webp';
import Image104 from '../asset/Our gallery/CampusConnection/img5.webp';
import Image105 from '../asset/Our gallery/CampusConnection/img1.webp';
...
function CampusConnection() {
  ...
  const images = [
    //{ src: Image100, date: '10 June 2025' },
    { src: Image101, date: '10 July 2025' },
    { src: Image102, date: '10 July 2025' },
      ...
      <div className="container">
        <div className="p-4 mx-auto text-center" style={styles.card}>
          <h2 className="mb-4 fw-bold text-primary">
            Campus Connection University Outreach program by Akashvani Patna (FM 102.5) 
            <br /><small>10 July 2025</small>
          </h2>
            ...
            {images.map((img, i) => (
              <div key={i} className="col-6 col-md-4 mb-3">
                ...
                >
                  ...
                  <div className="overlay" style={styles.overlay}>Campus Connection University Outreach program by Akashvani Patna (FM 102.5) | 10 July 2025
</div>
                </div>
              </div>
            ))}
      ...
      {zoomIndex !== null && (
        <div style={styles.zoom} onMouseMove={handleMouseMove}>
          ...
          <div style={{ ...styles.tooltip, top: hoverPos.y, left: hoverPos.x }}>
            Campus Connection University Outreach program by Akashvani Patna (FM 102.5) | 10 July 2025
          </div>
        </div>
      )}
    </div>
...
export default CampusConnection;
