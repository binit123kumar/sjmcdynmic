...
import Image103 from '../asset/Our gallery/Pbord/img1.webp';
import Image104 from '../asset/Our gallery/Pbord/img5.webp';
import Image105 from '../asset/Our gallery/Pbord/img6.webp';
import Image106 from '../asset/Our gallery/Pbord/img7.webp';
import Image107 from '../asset/Our gallery/Pbord/img8.webp';
import Image108 from '../asset/Our gallery/Pbord/img9.webp';
import Image109 from '../asset/Our gallery/Pbord/img10.webp';
import Image110 from '../asset/Our gallery/Pbord/img11.webp';
import Image111 from '../asset/Our gallery/Pbord/img12.webp';
import Image112 from '../asset/Our gallery/Pbord/img13.webp';
...
function Pbord () {
  ...
  const images = [
    ...
    { src: Image106, date: '07 May 2025' },
    { src: Image107, date: '07 May 2025' },
    { src: Image108, date: '207 May 2025' },
    { src: Image109, date: '07 May 2025' },
    { src: Image110, date: '07 May 2025' },
    { src: Image111, date: '07 May 2025' },
    { src: Image112, date: '07 May 2025' },
  ];
            ...
            {images.map((img, i) => (
              <div key={i} className="col-6 col-md-4 mb-3">
                ...
                >
                  ...
                  <div className="overlay" style={styles.overlay}>Board of Studies Meeting | 07 May 2025</div>
                </div>
              </div>
            ))}
          </div>
      ...
      {zoomIndex !== null && (
        <div style={styles.zoom} onMouseMove={handleMouseMove}>
          ...
          <div style={{ ...styles.tooltip, top: hoverPos.y, left: hoverPos.x }}>
           Board of Studies Meeting | 07 May 2025
          </div>
        </div>
      )}
    </div>
