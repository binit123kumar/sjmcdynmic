...
import Image1 from '../asset/Our gallery/aids/image (1).webp';
import Image2 from '../asset/Our gallery/aids/image (2).webp';
import Image3 from '../asset/Our gallery/aids/image (3).webp';
import Image4 from '../asset/Our gallery/aids/image (4).webp';
import Image5 from '../asset/Our gallery/aids/image (5).webp';
import Image6 from '../asset/Our gallery/aids/image (6).webp';
import Image7 from '../asset/Our gallery/aids/image (7).webp';
import Image8 from '../asset/Our gallery/aids/image (8).webp';
import Image9 from '../asset/Our gallery/aids/image (9).webp';
import Image10 from '../asset/Our gallery/aids/image (10).webp';
import Image11 from '../asset/Our gallery/aids/image (11).webp';
import Image12 from '../asset/Our gallery/aids/image (12).webp';
...
function Page39() {
  ...
  const images = [
    ...
    { src: Image3, date: '24 July 2025' },
    { src: Image4, date: '24 July 2025' },
    { src: Image5, date: '24 July 2025' },
    { src: Image6, date: '24 July 2025' },
    { src: Image7, date: '24 July 2025' },
    { src: Image8, date: '24 July 2025' },
    { src: Image9, date: '24 July 2025' },
    { src: Image10, date: '24 July 2025' },
    { src: Image11, date: '24 July 2025' },
    { src: Image12, date: '24 July 2025' },
  ];
    ...
    <div style={styles.container}>
      ...
      <div className="container">
        <div className="p-4 mx-auto text-center" style={styles.card}>
          ...
          Role of Youth in Combating AIDS | 05 October 2024
            <br /><small>05 October 2024</small>
          </h2>
            ...
            {images.map((img, i) => (
              <div key={i} className="col-6 col-md-4 mb-3">
                ...
                >
                  ...
                  <div className="overlay" style={styles.overlay}>Role of Youth in Combating AIDS | 05 October 2024</div>
                </div>
              </div>
            ))}
          </div>
