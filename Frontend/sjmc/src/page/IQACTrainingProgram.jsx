...
import Image101 from '../asset/Our gallery/IQACTrainingProgram/img1.webp';

function IQACTrainingProgram() {
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const images = [
    //{ src: Image100, date: '10 June 2025' },
    { src: Image101, date: '07 Feb 2025' },
      ...
      <div className="container">
        <div className="p-4 mx-auto text-center" style={styles.card}>
          <h2 className="mb-4 fw-bold text-primary">
            IQAC Training Program 

            <br /><small>07 Feb 2025</small>
          </h2>
            ...
            {images.map((img, i) => (
              <div key={i} className="col-6 col-md-4 mb-3">
                ...
                >
                  ...
                  <div className="overlay" style={styles.overlay}>IQAC Training Program | 07 Feb 2025
</div>
                </div>
              </div>
            ))}
      ...
      {zoomIndex !== null && (
        <div style={styles.zoom} onMouseMove={handleMouseMove}>
          ...
          <div style={{ ...styles.tooltip, top: hoverPos.y, left: hoverPos.x }}>
            IQAC Training Program | 07 Feb 2025
          </div>
        </div>
      )}
    </div>
...
export default IQACTrainingProgram;
