...
import Image1 from '../asset/Our gallery/unicef/image (1).webp';
import Image2 from '../asset/Our gallery/unicef/image (2).webp';
import Image3 from '../asset/Our gallery/unicef/image (3).webp';
import Image4 from '../asset/Our gallery/unicef/image (4).webp';
import Image5 from '../asset/Our gallery/unicef/image (5).webp';
import Image6 from '../asset/Our gallery/unicef/image (6).webp';
import Image7 from '../asset/Our gallery/unicef/image (7).webp';
...
function Page47() {
  ...
  const images = [
    { src: Image1, date: '10-11 February 2025' },
    { src: Image2, date: '10-11 February 2025' },
    { src: Image3, date: '10-11 February 2025' },
    { src: Image4, date: '10-11 February 2025'},
    { src: Image5, date: '10-11 February 2025' },
    { src: Image6, date: '10-11 February 2025' },
    { src: Image7, date: '10-11 February 2025' },
  ];
        ...
        <div className="p-4 mx-auto text-center" style={styles.card}>
          <h2 className="mb-4 fw-bold text-primary">
           Communication For Social and Behavior Change
            <br /><small>10-11 February 2025</small>
          </h2>
            ...
            {images.map((img, i) => (
              <div key={i} className="col-6 col-md-4 mb-3">
                ...
                >
                  ...
                  <div className="overlay" style={styles.overlay}>Communication For Social and Behavior Change| 10-11 February 2025
</div>
                </div>
              </div>
            ))}
