...
// Import images
import Image1 from '../asset/Our gallery/Course/image (1).webp';
import Image2 from '../asset/Our gallery/Course/image (2).webp';
import Image3 from '../asset/Our gallery/Course/image (3).webp';
import Image4 from '../asset/Our gallery/Course/image (4).webp';
import Image5 from '../asset/Our gallery/Course/image (5).webp';
import Image6 from '../asset/Our gallery/Course/image (6).webp';
import Image7 from '../asset/Our gallery/Course/image (8).webp';
import Image8 from '../asset/Our gallery/Course/image (7).webp';
import Image9 from '../asset/Our gallery/Course/image (9).webp';
import Image10 from '../asset/Our gallery/Course/image (10).webp';

function Page40() {
  useEffect(() => { window.scrollTo(0, 0); }, []);

  const images = [
    { src: Image1, date: '22 October2024' },
    { src: Image2, date: '22 October2024' },
    { src: Image3, date: '22 October2024' },
    { src: Image4, date: '22 October2024' },
    { src: Image5, date: '22 October2024' },
    { src: Image6, date: '22 October2024' },
    { src: Image7, date: '22 October2024' },
    { src: Image8, date: '22 October2024' },
    { src: Image9, date: '22 October2024' },
    { src: Image10, date: '22 October2024' },
  ];
...
Free Photography and Film Making Training Course|22 October2024
          {/* ✅ Image Grid */}
          <div className="row">
            {images.map((img, i) => (
              <div key={i} className="col-6 col-md-4 mb-3">
                ...
                >
                  ...
                  <div className="overlay" style={styles.overlay}>Free Photography and Film Making Training Course|22 October2024</div>
                </div>
              </div>
            ))}
          </div>
